  ...
  <div class="perfil w-25 mt-0 me-3 ms-3 mb-3">
    <div class="perfil-box w-100 h-100 box p-3">
        ...
        <div class="perfil-seguidores d-flex justify-content-center">
            <div class="perfil-seguidores-following text-center w-50 d-flex justify-content-center box">
                6,490
                Following
            </div>
            <div class="perfil-seguidores-followers text-center w-50 d-flex justify-content-center box">
                4,227
                Followers
            </div>
        </div>
        <div class="perfil-visualizar d-flex justify-content-center mt-3 box text-decoration-none" >
            <router-link class="box w-100 text-center text-decoration-none" :to="{ name: 'profile', params: { id: `${user.id}` }}">Meu Perfil</router-link>
        </div>
  </div>
  </div>
</template>
...
img, .perfil-box, .perfil-visualizar, .perfil-visualizar a {
    border-radius: 20px;
}
